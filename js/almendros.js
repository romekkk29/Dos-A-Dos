...
getGaleria.forEach((element,index)=>{
    element.addEventListener("click",function(){
            ...
            carrusel.innerHTML=" <div class=slide><img  loading=lazy src=img/almendros/ObraLosAlmendros1.jpg alt=LosAlmendros></div><div class=slide><img   loading=lazy src=img/almendros/ObraLosAlmendros2.jpg alt=LosAlmendros></div><div class=slide><img   loading=lazy src=img/almendros/ObraLosAlmendros3.jpg alt=LosAlmendros></div><div class=slide><img loading=lazy src=img/almendros/ObraLosAlmendros4.jpg alt=LosAlmendros></div><div class=slide><img  loading=lazy src=img/almendros/ObraLosAlmendros5.jpg alt=LosAlmendros></div><div class=slide><img  loading=lazy src=img/almendros/ObraLosAlmendros6.jpg alt=LosAlmendros></div>"
